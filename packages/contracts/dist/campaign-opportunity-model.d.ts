...
export declare function validateOpportunityWindowEvaluation(evaluation: Partial<OpportunityWindowEvaluation>): {
    valid: boolean;
    errors: string[];
};
export declare function validateMicroMarketOpportunity(evaluation: Partial<MicroMarketOpportunity>): {
    valid: boolean;
    errors: string[];
};
export declare function validateOpportunityDiscoveryRequest(request: Partial<OpportunityDiscoveryRequest>): {
    valid: boolean;
    errors: string[];
};
