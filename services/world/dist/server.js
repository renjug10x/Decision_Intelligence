...
const server = http.createServer((req, res) => {
    ...
    const tenantId = req.headers['x-tenant-id'] || reqUrl.query.tenant_id || 'tenant_uk_retail_01';
    ...
    if (pathname === '/api/v1/health') {
        const healthType = reqUrl.query.type || 'live';
    ...
    if (pathname === '/api/v1/scenarios') {
        const familyId = reqUrl.query.family_id;
        const scenarios = (0, index_1.generateCanonicalScenario)(familyId, tenantId);
