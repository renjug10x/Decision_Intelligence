...
const KNOWLEDGE_MODULES: Record<string, () => Promise<{ knowledge: CapabilityKnowledge }>> = {
  ...
  'cap-continuous-decision-twin': () => import('../../../content/atlas/capabilities/cap-continuous-decision-twin'),
  ...
  'cap-governed-forecast': () => import('../../../content/atlas/capabilities/cap-governed-forecast'),
  ...
  'cap-predictive-intervention': () => import('../../../content/atlas/capabilities/cap-predictive-intervention'),
