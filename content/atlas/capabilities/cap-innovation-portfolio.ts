...
export const knowledge = defineKnowledge({
  ...
  usage_instructions:
    'Open the Innovation Portfolio from the shell. Select an experiment to open its canvas, or a solution to open its surface.',
  ...
  implementation_references: [
    { path: 'components/InnovationPortfolio.tsx', note: 'Surface' },
    { path: 'config/experiments.ts', note: 'Experiment registry' },
    { path: 'config/solutions.ts', note: 'Solution registry' }
  ],
  validation_evidence: [
    { kind: 'code', ref: 'components/InnovationPortfolio.tsx', outcome: '269-line surface reading both registries.', observed_at: '2026-08-20', observed_by: 'ATL-03 reconciliation' },
