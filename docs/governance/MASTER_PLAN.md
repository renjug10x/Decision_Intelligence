...
| 4 | `SCI-10` (`SCI-08` delivered ahead, single lane) | **NOT CUT — BLOCKED.** `SCI-10` remains deferred and its Attested Upload contract is not declared; the Wave-4 gate has not run | — |
