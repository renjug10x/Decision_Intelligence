...
- **Status:** Approved; implementation in `SCI-07R` (2026-09-25). Closes the `SCI-08` entry blocker `R-SCI07-6`; closes `R-32`; narrows `R-28`. Design and evidence: [`COGNIX_SCI_07R_SCENARIO_REGISTRY_AUTHORITY_REPORT.md`](../reports/COGNIX_SCI_07R_SCENARIO_REGISTRY_AUTHORITY_REPORT.md). **No frozen contract changes.**
